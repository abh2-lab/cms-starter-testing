...
// Shared inline-SVG icon. Names map to trusted, static markup injected as the
// SVG's inner content. Stroke uses currentColor so icons adopt the button/text
// color of wherever they're placed.
withDefaults(
  defineProps<{
    name: string;
    size?: number | string;
...
const ICONS: Record<string, string> = {
  ...
  'list-ordered':
    '<line x1="10" y1="6" x2="21" y2="6"/><line x1="10" y1="12" x2="21" y2="12"/><line x1="10" y1="18" x2="21" y2="18"/><path d="M4 6h1v4"/><path d="M4 10h2"/>',
  quote:
  ...
  undo: '<polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 .49-3.66"/>',
  redo: '<polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-.49-3.66"/>',
  maximize:
  ...
  braces:
    '<path d="M7 4a2 2 0 0 0-2 2v3a2 2 0 0 1-2 2 2 2 0 0 1 2 2v3a2 2 0 0 0 2 2"/><path d="M17 4a2 2 0 0 1 2 2v3a2 2 0 0 0 2 2 2 2 0 0 0-2 2v3a2 2 0 0 1-2 2"/>',
  section:
    '<line x1="4" y1="7" x2="11" y2="7"/><line x1="4" y1="12" x2="20" y2="12"/><line x1="4" y1="17" x2="20" y2="17"/>',
  droplet: '<path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z"/>',
};
</script>

<template>
  <!-- ICONS is a dev-controlled, static map of inline SVG path markup; the rendered value never comes from user input. -->
